...
// 1️⃣ Crear contenedor principal
(function() {
  // Inyectar CSS
  ...
  /* Estilo para la animación de los tres puntos */
  .loading-dots {
    display: inline-block;
    font-size: 24px;
  }
  ...
  <div id="chat-container">
    ...
    <div id="chat-box">
      <div class="bot-first-message">
        <div class="message bot" style="padding-bottom: 2px; padding-top: 0px">
          ...
          <div class="bot-text">
            ¡Hola, soy Astu 👋 Estoy aquí para ayudarte con la
            internacionalización de tu empresa e informarte sobre los eventos
        ...
        <div class="message bot" style="padding-bottom: 2px; padding-top: 2px">
          <div class="bot-triangle"></div>
          <div class="bot-text">
            Al continuar con la Conversación, aceptas nuestra
            <a style="color: #4382ff; text-decoration: underline"
              href="https://www.asturex.org/politica-de-privacidad-y-aviso-legal" target="_blank">política de
              privacidad</a>
            <!--y
              <a
        ...
        <div class="message bot" style="padding-top: 2px; padding-bottom: 10px">
          <div class="bot-triangle"></div>
          <div class="bot-text">¿En que te puedo ayudar hoy?</div>
        </div>
      </div>
    ...
    <div id="terms-container">
      <h2>
        ...
        <a href="https://soysabia.es/politica-de-privacidad" target="_blank">política de privacidad</a>
  ...
  wrapper.innerHTML = chatContainerHTML;
  body.appendChild(wrapper);

  // Esperar a que marked cargue y luego inicializar el JS
  markedScript.onload = () => {
    // Código JS de tu chat
    (function(){
